...
def Dockerize(repository, project):
    ...
    print("docker run --name putyournamehere --restart=always -p 445:445 -e MY_USERNAME=\"username\" -e MY_PASSWORD=\"password\" " + repository + "/" + project)
...
if __name__ == "__main__":
    Dockerize('haraldegger', 'docker-nas')
